...
# normal_change_log = [(['ts-route-service'], 1651336284203, 1651336591289), (['ts-order-service'], 1651339128677, 1651339447658), (['ts-auth-service'], 1651340310338, 1651340616308), (['ts-route-service'], 1651340906577, 1651341279170), (['ts-auth-service'], 1651342623862, 1651342929443), (['ts-auth-service'], 1651345583855, 1651345888429), (['ts-auth-service'], 1651347389247, 1651347692342), (['ts-order-service'], 1651347982613, 1651348289177), (['ts-route-service'], 1651350706119, 1651351073675), (['ts-order-service'], 1651351363936, 1651351680923), (['ts-route-service'], 1651352546187, 1651352883150), (['ts-order-service'], 1651353173415, 1651353484333), (['ts-auth-service'], 1651353754565, 1651354057443), (['ts-order-service'], 1651354831682, 1651355142269), (['ts-route-service'], 1651360045297, 1651360433206), (['ts-auth-service'], 1651360703445, 1651361007938), (['ts-auth-service'], 1651361781850, 1651362085450), (['ts-route-service'], 1651362365701, 1651362719814), (['ts-route-service'], 1651364225560, 1651364641114)]
