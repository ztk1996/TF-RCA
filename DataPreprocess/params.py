...
new_data_list = [
    ...
    # 'chaos/2022-04-27_15-00-00_8h_traces.csv', # 1 abnormal
    # 'chaos/2022-04-28_12-00-00_8h_traces.csv', # 2 abnormal
    # 'chaos/2022-04-28_23-00-00_6h_traces.csv' # 1 change
    # 'chaos/2022-05-01_00-00-00_9h_traces.csv' # 1 change
    # 'chaos/2022-05-03_10-00-00_8h_traces.csv',  # 1 change new
...
# 2022-4-26 21:00:00 8h abnormal 1 调整case
...
# 2022-4-27 15:00:00 8h abnormal 1
...
# 2022-4-28 12:00:00 8h abnormal 2 增加数据量
...
# 2022-4-28 23:00:00 6h change 1
...
# 2022-5-1 00:00:00 9h change 1 记录正常变更时间
...
# 2022-05-03_10-00-00_8h_traces.csv abnormal 1 45case 增加数据量
...
# add new cases
# 2022-05-04_16-00-00_8h abnormal 1
# request_period_log = [(['ts-seat-service'], 1651651914438, 1651652223386), (['ts-basic-service'], 1651652413788, 1651652718618), (['ts-ticketinfo-service'], 1651652909019, 1651653214154), (['ts-order-other-service'], 1651653404549, 1651653705472), (['ts-consign-service'], 1651653895895, 1651654200739), (['ts-price-service'], 1651654391132, 1651654696069), (['ts-travel-service'], 1651654886494, 1651655249419), (['ts-route-service'], 1651655502082, 1651655805608), (['ts-travel-service'], 1651655996019, 1651656298733), (['ts-train-service'], 1651656489142, 1651656793970), (['ts-config-service'], 1651656984387, 1651657287318), (['ts-order-service'], 1651657477713, 1651657781729), (['ts-route-service'], 1651657972145, 1651658277172), (['ts-train-service'], 1651658467579, 1651658772998), (['ts-user-service'], 1651658963419, 1651659267836), (['ts-route-service'], 1651659458258, 1651659761384), (['ts-ticketinfo-service'], 1651659951782, 1651660256311), (['ts-price-service'], 1651660446723, 1651660751743), (['ts-basic-service'], 1651660942170, 1651661244194), (['ts-user-service'], 1651661434587, 1651661737316), (['ts-order-other-service'], 1651661927738, 1651662231066), (['ts-price-service'], 1651662421466, 1651662723712), (['ts-order-other-service'], 1651662914115, 1651663217854), (['ts-travel-plan-service'], 1651663408262, 1651663711516), (['ts-train-service'], 1651663901912,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        #    1651664207042), (['ts-config-service'], 1651664397443, 1651664702365), (['ts-rebook-service'], 1651664892776, 1651665198006), (['ts-consign-service'], 1651665388412, 1651665692756), (['ts-order-service'], 1651665883164, 1651666188004), (['ts-route-service'], 1651666378413, 1651666682241), (['ts-rebook-service'], 1651666872666, 1651667176891), (['ts-station-service'], 1651667367299, 1651667672037), (['ts-ticketinfo-service'], 1651667862456, 1651668167687), (['ts-travel-service'], 1651668358079, 1651668661205), (['ts-seat-service'], 1651668851601, 1651669156528), (['ts-rebook-service'], 1651669346924, 1651669651854), (['ts-station-service'], 1651669842259, 1651670145786), (['ts-config-service'], 1651670336208, 1651670641926), (['ts-consign-service'], 1651670832327, 1651671136256), (['ts-station-service'], 1651671326655, 1651671631774), (['ts-order-service'], 1651671822191, 1651672126023), (['ts-basic-service'], 1651672316444, 1651672620465), (['ts-travel-plan-service'], 1651672810874, 1651673113294), (['ts-seat-service'], 1651673303720, 1651673606642), (['ts-user-service'], 1651673797042, 1651674102058), (['ts-basic-service'], 1651674292467, 1651674593087), (['ts-basic-service'], 1651674783504, 1651675087413), (['ts-basic-service'], 1651675277828, 1651675580851), (['ts-order-service'], 1651675771242, 1651676075774), (['ts-order-service'], 1651676266188, 1651676571211)]

# 2022-05-04_16-00-00_8h_traces.csv abnormal 2
# request_period_log = [(['ts-travel-service', 'ts-config-service'], 1651681742463, 1651682104315), (['ts-route-service', 'ts-order-service'], 1651682357312, 1651682663650), (['ts-travel-service', 'ts-consign-service'], 1651682854346, 1651683160601), (['ts-price-service', 'ts-basic-service'], 1651683351297, 1651683658341), (['ts-train-service', 'ts-basic-service'], 1651683849050, 1651684153608), (['ts-consign-service', 'ts-basic-service'], 1651684344331, 1651684648566), (['ts-order-service', 'ts-basic-service'], 1651684839283, 1651685146534), (['ts-price-service', 'ts-consign-service'], 1651685337232, 1651685648580), (['ts-basic-service', 'ts-order-service'], 1651685839300, 1651686146256), (['ts-seat-service', 'ts-basic-service'], 1651686336976, 1651686643524), (['ts-user-service', 'ts-rebook-service'], 1651686834225, 1651687141182), (['ts-order-other-service', 'ts-price-service'], 1651687331880, 1651687638625), (['ts-config-service', 'ts-train-service'], 1651687829351, 1651688147915), (['ts-ticketinfo-service', 'ts-rebook-service'], 1651688338613, 1651688645767), (['ts-route-service', 'ts-config-service'], 1651688836459, 1651689138793), (['ts-station-service', 'ts-price-service'], 1651689329497, 1651689636542), (['ts-travel-plan-service', 'ts-user-service'], 1651689827279, 1651690134719), (['ts-user-service', 'ts-order-service'], 1651690325437, 1651690631493), (['ts-order-other-service', 'ts-travel-plan-service'], 1651690822171, 1651691128308), (['ts-route-service', 'ts-config-service'], 1651691319009, 1651691626754), (['ts-consign-service', 'ts-train-service'], 1651691817471, 1651692127625), (['ts-user-service', 'ts-order-other-service'], 1651692318344, 1651692625684), (['ts-train-service', 'ts-station-service'], 1651692816374, 1651693121221), (['ts-station-service', 'ts-consign-service'], 1651693311903, 1651693617435), (['ts-order-other-service', 'ts-travel-service'], 1651693808110, 1651694170252), (['ts-seat-service', 'ts-travel-service'], 1651694360960, 1651694666201), (['ts-basic-service', 'ts-order-service'], 1651694856920, 1651695164051), (['ts-travel-service', 'ts-travel-service'], 1651695354748, 1651695659083), (['ts-order-service', 'ts-station-service'], 1651695849801, 1651696155236), (['ts-config-service', 'ts-rebook-service'], 1651696345940, 1651696652973), (['ts-route-service', 'ts-rebook-service'], 1651696843692, 1651697145315), (['ts-order-service', 'ts-train-service'], 1651697336015, 1651697641956), (['ts-station-service', 'ts-rebook-service'], 1651697832662, 1651698138298), (['ts-ticketinfo-service', 'ts-route-service'], 1651698329005, 1651698635349), (['ts-user-service', 'ts-order-other-service'], 1651698826080, 1651699129511), (['ts-seat-service', 'ts-travel-plan-service'], 1651699320223, 1651699624774), (['ts-station-service', 'ts-train-service'], 1651699815494, 1651700129351), (['ts-seat-service', 'ts-ticketinfo-service'], 1651700320051, 1651700623586), (['ts-consign-service', 'ts-rebook-service'], 1651700814306, 1651701118264), (['ts-price-service', 'ts-ticketinfo-service'], 1651701308945, 1651701630436), (['ts-basic-service', 'ts-basic-service'], 1651701821146, 1651702141928), (['ts-ticketinfo-service', 'ts-config-service'], 1651702332646, 1651702639905), (['ts-ticketinfo-service', 'ts-order-service'], 1651702830619, 1651703138299), (['ts-route-service', 'ts-seat-service'], 1651703329015, 1651703633671), (['ts-route-service', 'ts-travel-plan-service'], 1651703824371, 1651704131045), (['ts-seat-service', 'ts-order-other-service'], 1651704321752, 1651704627829), (['ts-order-service', 'ts-basic-service'], 1651704818546, 1651705128741), (['ts-price-service', 'ts-user-service'], 1651705319453, 1651705626858), (['ts-route-service', 'ts-basic-service'], 1651705817573, 1651706127375), (['ts-order-service', 'ts-basic-service'], 1651706318068, 1651706622443)]

# case fixed
# 2022-05-05_19-00-00_8h_traces.csv abnormal 1
