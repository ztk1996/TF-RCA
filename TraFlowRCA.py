...
from DataPreprocess.params import request_period_log, normal_change_log
...
def init_Cluster(cluster_obj, init_start_str):
    ...
    if dataLevel == 'trace':
        ...
        file = open(r'/home/kagaya/work/TF-RCA/DataPreprocess/data/preprocessed/wechat/2022-05-31_18-40-09/data.json', 'r')    # new
...
def main():
    ...
    if dataLevel == 'trace':
        ...
        file = open(r'/home/kagaya/work/TF-RCA/DataPreprocess/data/preprocessed/wechat/2022-05-31_18-40-09/data.json', 'r')    # change new 5-10
        raw_data_total = json.load(file)
        get_operation_service_pairs(raw_data_total)
